...
![GitHub Repo stars](https://img.shields.io/github/stars/ModifiedZer0/VCPlayerBot?color=blue&style=flat)
![GitHub issues](https://img.shields.io/github/issues/ModifiedZer0/VCPlayerBot)
![GitHub pull requests](https://img.shields.io/github/issues-pr/ModifiedZer0/VCPlayerBot)
![GitHub contributors](https://img.shields.io/github/contributors/ModifiedZer0/VCPlayerBot?style=flat)
![GitHub forks](https://img.shields.io/github/forks/ModifiedZer0/VCPlayerBot?style=flat)
...
4. `SESSION_STRING` : Generate From here [![GenerateStringName](https://img.shields.io/badge/repl.it-generateStringName-yellowgreen)](https://repl.it/@ModifiedZer0/getStringName)
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/ModifiedZer0/VCPlayerBot)

## Deploy to Railway
<p><a href=https://github.com/ModifiedZer0/VCPlayerBot/issues/7> <img src="https://img.shields.io/badge/Deploy%20To%20Railway-blueviolet?style=for-the-badge&logo=railway" width="200""/></a></p>

 
## Deploy to VPS

```sh
git clone https://github.com/ModifiedZer0/VCPlayerBot
cd VCPlayerBot
